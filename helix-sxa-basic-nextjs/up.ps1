...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.basic-company-nextjs.localhost/ --auth https://id.basic-company-nextjs.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
